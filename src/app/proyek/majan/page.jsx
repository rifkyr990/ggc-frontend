...
const brochureImages = [
  ...
  "/image/proyek/majan/6.png",
  "/image/proyek/majan/7.png",
  "/image/proyek/majan/8.png",
  "/image/proyek/majan/9.png",
  "/image/proyek/majan/10.png",
  "/image/proyek/majan/11.png",
  "/image/proyek/majan/12.png",
  "/image/proyek/majan/13.png",
  "/image/proyek/majan/14.png",

];

export default function ProyekMajanPage() {
          ...
          <section className="w-full max-w-5xl mx-auto mb-12 px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="bg-gray-800 rounded-xl shadow-lg border-2 border-yellow-400 flex flex-col items-center p-4">
                <img
                  src="/image/proyek/majan/10.png"
                  alt="Tipe 36"
                  className="w-full h-40 object-cover rounded-lg mb-3 border border-yellow-300"
                />
                <h3 className="text-xl font-bold text-yellow-300 mb-1">Tipe 36</h3>
                <p className="text-gray-200 text-center text-sm">
                  Rumah minimalis, cocok untuk keluarga muda. 2 kamar tidur, 1 kamar mandi, carport.
                </p>
              </div>
              {/* Ruko */}
              <div className="bg-gray-800 rounded-xl shadow-lg border-2 border-yellow-400 flex flex-col items-center p-4">
                <img
                  src="/image/proyek/majan/7.png"
                  alt="Ruko"
                  className="w-full h-40 object-cover rounded-lg mb-3 border border-yellow-300"
                />
                <h3 className="text-xl font-bold text-yellow-300 mb-1">Ruko</h3>
                <p className="text-gray-200 text-center text-sm">
                  Ruko strategis untuk usaha dan tempat tinggal, desain modern, lokasi depan jalan utama.
                </p>
              </div>
            </div>
          </section>
