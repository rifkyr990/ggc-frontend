        ...
        <div className="bg-white bg-opacity-90 rounded-3xl shadow-2xl p-10 max-w-4xl w-full border-4 border-yellow-400">
          ...
          <div className="mb-6 flex flex-col gap-2 items-center">
            <p className="text-lg font-semibold text-blue-900">
              ...
              XW44+JJW Majan, Ketanon, Tulungagung Regency, East Java
            </p>
          </div>
          <div className="mb-8 rounded-xl overflow-hidden shadow-lg border-2 border-yellow-200 w-full h-[40vh] sm:h-[50vh] md:h-[60vh]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3950.568167333068!2d111.906572!3d-8.043377!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zOMKwMDInMzYuMiJTIDExMcKwNTQnMjMuNyJF!5e0!3m2!1sen!2sid!4v1753705374852!5m2!1sen!2sid"
              width="100%"
              height="100%"
              ...
              title="Lokasi Graha Indah Majan"
