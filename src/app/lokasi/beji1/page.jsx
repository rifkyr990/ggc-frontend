...
export default function LokasiBeji1Page() {
  return (
    <>
      <Navbar />
        ...
        <div className="bg-white bg-opacity-90 rounded-3xl shadow-2xl p-10 max-w-4xl w-full border-4 border-yellow-400">
          ...
          <div className="mb-6 flex flex-col gap-2 items-center">
            <p className="text-lg font-semibold text-blue-900">
              ...
              Alamat: Jl. Raya Beji No.123, Beji, Kabupaten Tulungagung, Jawa
              Timur
            </p>
          </div>
          <div className="mb-8 rounded-xl overflow-hidden shadow-lg border-2 border-yellow-200">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3950.1750719411507!2d111.907196!3d-8.083620999999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zOMKwMDUnMDEuMCJTIDExMcKwNTQnMjUuOSJF!5e0!3m2!1sid!2sid!4v1753637802921!5m2!1sid!2sid"
              width="100%"
              height="350"
              style={{ border: 0 }}
              allowFullScreen=""
              ...
              title="Lokasi Graha Indah Beji 1 di Google Maps"
            ></iframe>
          </div>
