        ...
        <div>
            ...
            <main className="md:ml-64 p-6 bg-gray-100 min-h-screen">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                    {[
                        { label: 'Users', value: '26K', change: '-12.4%', color: 'bg-purple-500' },
                        { label: 'Income', value: '$6,200', change: '+40.9%', color: 'bg-blue-500' },
                        { label: 'Conversion Rate', value: '2.49%', change: '+84.7%', color: 'bg-yellow-500' },
                        { label: 'Sessions', value: '44K', change: '-23.6%', color: 'bg-red-500' },
                    ].map((item, i) => (
                        <div key={i} className={`${item.color} text-white p-4 rounded-lg shadow`}>
                ...
                <div className="bg-white p-6 rounded-lg shadow">
                    <h3 className="text-lg font-semibold mb-4">Traffic (January - July 2023)</h3>
